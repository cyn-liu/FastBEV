...
# if 'BBox3DL1Cost' in TASK_UTILS._module_dict:
#     TASK_UTILS._module_dict.pop('BBox3DL1Cost')
# TASK_UTILS._module_dict.pop('FocalLossCost')
# TASK_UTILS._module_dict.pop('IoUCost')
