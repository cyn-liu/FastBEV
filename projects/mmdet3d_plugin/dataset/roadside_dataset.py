...
__all__ = ['RoadsideDataset']


@DATASETS.register_module()
class RoadsideDataset(Det3DDataset):

    CLASSES =  ("Pedestrian", "Car","MotorcyleRider", "Crane",
                "Motorcycle", "Bus", "BicycleRider", "Van", "Excavator",
                "TricycleRider","Truck")
    METAINFO = {
        'classes':
        CLASSES,
    ...
    def __init__(self,
                 ...
                 pred_score_thr: float = 0.8,
                 order_input: bool = True,
                 fps: int = 10,
    ...
    def vis(self, results, runner):
        ...
        for i in range(len(results)):
            ...
            boxes_3d = box_type(boxes_3d, box_dim=7, origin=(0.5, 0.5, 0.5)).convert_to(self.box_mode_3d)
