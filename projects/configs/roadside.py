...
epochs = 50
num_workers = 4
point_cloud_range = [0, -50, -5, 100, 50, 0]
bev_size = [200, 200]
...
n_cams = 3
img_input_final_dim = (384, 640)  # h w
...
model = dict(
    ...
    bbox_head=dict(
        ...
        anchor_generator=dict(
            ...
            ranges=[[*point_cloud_range[:2], -3.55, *point_cloud_range[3:5], -3.55]],
            sizes=[
...
train_dataloader = dict(
    ...
    dataset=dict(
        type='CBGSDataset',dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file='roadside_infos_train.pkl',
